...
module.exports = {
    ...
    create(context) {
        ...
        function collectUnhandledErrors(scope, unhandledErrors) {
            const { childScopes, variables } = scope;
            let i, l;
            ...
            "Program:exit"(programNode) {
                ...
                for (let i = 0, l = unhandledErrors.length; i < l; ++i) {
                    ...
                    if (unhandledError.defs.length > 0) {
                        ...
                        const writeReferences = unhandledError.references.filter(ref => ref.isWrite() && ref.from.variableScope === unhandledError.scope.variableScope);
