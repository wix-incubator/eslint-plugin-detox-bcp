 ...
 * @typedef {Object} UnhandledErrorMessageData
...
module.exports = {
  meta: {
    ...
    docs: {
      description: "disallow unhandled errors in try-catch statements",
      category: "Variables",
      url: "https://github.com/wix-incubator/eslint-plugin-detox-bcp/blob/main/README.md"
    },
  ...
  create(context) {
    ...
    /**
         ...
         * @returns {UnhandledErrorMessageData} The message data to be used with this unhandled error.
         */
